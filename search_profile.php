...
{   
	...
	$query=mysqli_query($connect,"SELECT url FROM accounts WHERE (`name` LIKE '%".$searched_profile."%')");
    $res=mysqli_fetch_array($query);
	$fetch=$res['url'];
	$query1=mysqli_query($connect,"SELECT * FROM accounts WHERE (`name` LIKE '%".$searched_profile."%')");
  ...
  <div class="wrapper">
      ...
      <div class="col-md-5  toppad  pull-right col-md-offset-3 ">
        ...
        <span class="pull-right">
         <a href="profile1.php" data-original-title="Remove this user" data-toggle="tooltip" type="button" class="btn btn-sm btn-danger"><i class="glyphicon glyphicon-chevron-left"></i></a>
        </span>
        </h3>
            </div>
